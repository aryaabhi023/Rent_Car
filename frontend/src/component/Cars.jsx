            ...
            >
              ...
              <div className="flex justify-around items-center bg-gray-100 p-1 rounded-lg shadow-md">
                <div className="flex flex-col items-center">
                  ...
                  />
                  <span className="text-gray-700 text-sm">{car.speed} km/h</span>
                </div>
                <div className="flex flex-col items-center">
                  <FontAwesomeIcon
                    icon={faGasPump}
              ...
              <div className="flex justify-between items-center mt-2">
                ...
                <span>
                  <h3 className="inline font-bold">Rent: </h3>
                  ₹{car.price}/Day
                </span>
              </div>
              <button
                className="flex w-full justify-around items-center bg-gradient-to-r from-red-600/50 via-red-600/80 to-red-700/50 p-4 mt-1 font-bold rounded-lg shadow-md"
                onClick={() => {
